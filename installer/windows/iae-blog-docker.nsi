...
Section "MainSection" SEC01
  ...
  ; Iniciar instalacion/arranque usando solo BAT
  DetailPrint "Iniciando instalacion/arranque (BAT)..."
  nsExec::ExecToLog 'cmd /c "$INSTDIR\scripts\windows\start-docker.bat"'
